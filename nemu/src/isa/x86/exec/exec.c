...
static OpcodeEntry opcode_table [512] = {
  ...
  /* 0x30 */	EMPTY, IDEX(xor, xor), EMPTY, EMPTY,
  ...
  /* 0x50 */	IDEX(push_reg, push), IDEX(push_reg, push), IDEX(push_reg, push), IDEX(push_reg, push),
  /* 0x54 */	IDEX(push_reg, push), IDEX(push_reg, push), IDEX(push_reg, push), IDEX(push_reg, push),
  /* 0x58 */	IDEX(pop_reg, pop), IDEX(pop_reg, pop), IDEX(pop_reg, pop), IDEX(pop_reg, pop),
  /* 0x5c */	IDEX(pop_reg, pop), IDEX(pop_reg, pop), IDEX(pop_reg, pop), IDEX(pop_reg, pop),
  /* 0x60 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x64 */	EMPTY, EMPTY, EX(operand_size), EMPTY,
  /* 0x68 */	IDEX(push_imm, push), EMPTY, EMPTY, EMPTY,
  ...
  /* 0xe8 */	IDEX(call_rel, call), EMPTY, EMPTY, EMPTY,
